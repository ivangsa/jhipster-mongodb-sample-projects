    ...
    describe('ShippingDetails Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/shipping-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a ShippingDetails', () => {
                service.create(new ShippingDetails(null)).subscribe(received => {
            ...
            it('should update a ShippingDetails', () => {
                service.update(new ShippingDetails('123')).subscribe(received => {
            ...
            it('should return a ShippingDetails', () => {
            ...
            it('should return a list of ShippingDetails', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ShippingDetails('123')]);
            });
