...
export class CustomerOrderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.customerOrderService
            ...
            .subscribe(
                (res: HttpResponse<ICustomerOrder[]>) => this.paginateCustomerOrders(res.body, res.headers),
    ...
    private paginateCustomerOrders(data: ICustomerOrder[], headers: HttpHeaders) {
