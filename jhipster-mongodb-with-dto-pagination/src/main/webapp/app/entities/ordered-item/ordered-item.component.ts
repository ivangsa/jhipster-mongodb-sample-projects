...
export class OrderedItemComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.orderedItemService
            ...
            .subscribe(
                (res: HttpResponse<IOrderedItem[]>) => this.paginateOrderedItems(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/ordered-item'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateOrderedItems(data: IOrderedItem[], headers: HttpHeaders) {
