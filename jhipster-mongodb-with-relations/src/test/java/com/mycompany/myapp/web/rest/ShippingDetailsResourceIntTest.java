...
import com.mycompany.myapp.JhipsterMongodbWithRelationsApp;
...
@SpringBootTest(classes = JhipsterMongodbWithRelationsApp.class)
public class ShippingDetailsResourceIntTest {
    ...
    public void setup() {
        ...
        final ShippingDetailsResource shippingDetailsResource = new ShippingDetailsResource(shippingDetailsRepository);
