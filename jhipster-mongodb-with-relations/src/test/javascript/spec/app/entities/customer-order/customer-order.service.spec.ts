    ...
    describe('CustomerOrder Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a CustomerOrder', () => {
                service.create(new CustomerOrder(null)).subscribe(received => {
            ...
            it('should update a CustomerOrder', () => {
                service.update(new CustomerOrder('123')).subscribe(received => {
            ...
            it('should return a CustomerOrder', () => {
            ...
            it('should return a list of CustomerOrder', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CustomerOrder('123')]);
            });
