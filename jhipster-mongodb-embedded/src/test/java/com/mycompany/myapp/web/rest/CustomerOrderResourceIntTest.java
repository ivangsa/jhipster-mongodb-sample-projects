...
public class CustomerOrderResourceIntTest {
    ...
    private static final PaymentDetails DEFAULT_PAYMENT_DETAILS = new PaymentDetails();
    private static final PaymentDetails UPDATED_PAYMENT_DETAILS = new PaymentDetails();
    private static final ShippingDetails DEFAULT_SHIPPING_DETAILS = new ShippingDetails();
    private static final ShippingDetails UPDATED_SHIPPING_DETAILS = new ShippingDetails();
    ...
    public void createCustomerOrder() throws Exception {
        ...
        assertThat(testCustomerOrder.getPaymentDetails()).isEqualTo(DEFAULT_PAYMENT_DETAILS);
        assertThat(testCustomerOrder.getShippingDetails()).isEqualTo(DEFAULT_SHIPPING_DETAILS);
    }
    ...
    public void getAllCustomerOrders() throws Exception {
        ...
        restCustomerOrderMockMvc.perform(get("/api/customer-orders?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].shippingDetails").value(hasItem(DEFAULT_SHIPPING_DETAILS.toString())));
    }
    
    public void getAllCustomerOrdersWithEagerRelationshipsIsEnabled() throws Exception {
        CustomerOrderResource customerOrderResource = new CustomerOrderResource(customerOrderRepositoryMock);
    ...
    public void getCustomerOrder() throws Exception {
        ...
        restCustomerOrderMockMvc.perform(get("/api/customer-orders/{id}", customerOrder.getId()))
            ...
            .andExpect(jsonPath("$.shippingDetails").value(DEFAULT_SHIPPING_DETAILS.toString()));
    }
    @Test
    ...
    public void updateCustomerOrder() throws Exception {
        ...
        assertThat(testCustomerOrder.getPaymentDetails()).isEqualTo(UPDATED_PAYMENT_DETAILS);
        assertThat(testCustomerOrder.getShippingDetails()).isEqualTo(UPDATED_SHIPPING_DETAILS);
    }
