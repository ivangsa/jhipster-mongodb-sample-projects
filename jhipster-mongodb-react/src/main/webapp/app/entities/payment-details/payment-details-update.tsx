...
export class PaymentDetailsUpdate extends React.Component<IPaymentDetailsUpdateProps, IPaymentDetailsUpdateState> {
  ...
  render() {
    const { paymentDetailsEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterMongodbReactApp.paymentDetails.home.createOrEditLabel">
              <Translate contentKey="jhipsterMongodbReactApp.paymentDetails.home.createOrEditLabel">
                Create or edit a PaymentDetails
              </Translate>
            </h2>
          </Col>
        </Row>
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : paymentDetailsEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="creditCardNumberLabel" for="creditCardNumber">
                    <Translate contentKey="jhipsterMongodbReactApp.paymentDetails.creditCardNumber">Credit Card Number</Translate>
                  </Label>
                  <AvField id="payment-details-creditCardNumber" type="text" name="creditCardNumber" />
                </AvGroup>
