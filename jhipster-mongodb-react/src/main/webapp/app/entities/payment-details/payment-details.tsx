...
export type IPaymentDetailsState = IPaginationBaseState;

export class PaymentDetails extends React.Component<IPaymentDetailsProps, IPaymentDetailsState> {
  ...
  render() {
    const { paymentDetailsList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="payment-details-heading">
          <Translate contentKey="jhipsterMongodbReactApp.paymentDetails.home.title">Payment Details</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterMongodbReactApp.paymentDetails.home.createLabel">Create new Payment Details</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('creditCardNumber')}>
