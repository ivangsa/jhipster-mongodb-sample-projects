  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMongodbReactApp.customer.delete.question">
          <Translate contentKey="jhipsterMongodbReactApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
