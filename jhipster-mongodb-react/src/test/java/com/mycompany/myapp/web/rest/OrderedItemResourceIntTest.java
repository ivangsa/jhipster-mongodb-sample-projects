...
import com.mycompany.myapp.JhipsterMongodbReactApp;
...
@SpringBootTest(classes = JhipsterMongodbReactApp.class)
public class OrderedItemResourceIntTest {
    ...
    public void setup() {
        ...
        final OrderedItemResource orderedItemResource = new OrderedItemResource(orderedItemService);
    ...
    public void createOrderedItem() throws Exception {
        ...
        OrderedItemDTO orderedItemDTO = orderedItemMapper.toDto(orderedItem);
        restOrderedItemMockMvc.perform(post("/api/ordered-items")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(orderedItemDTO)))
    ...
    public void updateOrderedItem() throws Exception {
        ...
        OrderedItemDTO orderedItemDTO = orderedItemMapper.toDto(updatedOrderedItem);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(OrderedItemDTO.class);
        OrderedItemDTO orderedItemDTO1 = new OrderedItemDTO();
        orderedItemDTO1.setId("id1");
        OrderedItemDTO orderedItemDTO2 = new OrderedItemDTO();
        assertThat(orderedItemDTO1).isNotEqualTo(orderedItemDTO2);
        orderedItemDTO2.setId(orderedItemDTO1.getId());
        assertThat(orderedItemDTO1).isEqualTo(orderedItemDTO2);
        orderedItemDTO2.setId("id2");
        assertThat(orderedItemDTO1).isNotEqualTo(orderedItemDTO2);
        orderedItemDTO1.setId(null);
        assertThat(orderedItemDTO1).isNotEqualTo(orderedItemDTO2);
    }
}
