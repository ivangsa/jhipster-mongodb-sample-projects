...
export class PaymentDetailsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.paymentDetailsService
            ...
            .subscribe(
                (res: HttpResponse<IPaymentDetails[]>) => this.paginatePaymentDetails(res.body, res.headers),
    ...
    private paginatePaymentDetails(data: IPaymentDetails[], headers: HttpHeaders) {
