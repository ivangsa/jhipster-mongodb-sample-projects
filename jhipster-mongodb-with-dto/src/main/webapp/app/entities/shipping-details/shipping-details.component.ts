...
export class ShippingDetailsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.shippingDetailsService
            ...
            .subscribe(
                (res: HttpResponse<IShippingDetails[]>) => this.paginateShippingDetails(res.body, res.headers),
    ...
    private paginateShippingDetails(data: IShippingDetails[], headers: HttpHeaders) {
